...
export async function generateDockerCompose(projectPath: string, name: string): Promise<void> {
...
export async function generateDockerfiles(projectPath: string): Promise<void> {
...
export async function runDockerInfrastructure(projectPath: string): Promise<void> {
