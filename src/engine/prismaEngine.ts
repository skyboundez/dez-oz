...
export async function generatePrismaSchema(dbPackagePath: string): Promise<void> {
...
export async function runPrismaGenerate(projectPath: string): Promise<void> {
...
export async function runPrismaMigrate(projectPath: string): Promise<void> {
